...
export function AuroraTopbar({ title, subtitle, searchPlaceholder = "Buscar registros...", actions, className }: AuroraTopbarProps) {
  return (
    <header className={cn("flex flex-col gap-4 rounded-[24px] border border-[#E5E7EB] bg-white px-5 py-4 shadow-[0_4px_12px_rgba(0,0,0,0.06)] xl:flex-row xl:items-center xl:justify-between", className)}>
      ...
      <div className="flex min-w-0 flex-col gap-3 md:flex-row md:items-center">
        <div className="min-w-0 flex-1 md:w-[420px] md:flex-none">
